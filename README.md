...
### Paso 4. Modificar URL y credenciales
 ...
 Modificar la URL y las credenciales de acceso a la petición en ***test/Api/ReporteDeCrditoRenuevaApiTest.php***, como se muestra en el siguiente fragmento de código:
