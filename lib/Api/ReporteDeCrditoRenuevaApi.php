...
namespace RcRenueva\Client\Api;
...
use RcRenueva\Client\ApiException;
use RcRenueva\Client\Configuration;
use RcRenueva\Client\HeaderSelector;
...
class ReporteDeCrditoRenuevaApi
{
    ...
    {
        $returnType = '\RcRenueva\Client\Model\Respuesta';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RcRenueva\Client\Model\Respuesta',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RcRenueva\Client\Model\Errores',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
